 ...
 * spell out for every width and column by hand. The model is deliberately naive
 * and independent of xterm, so agreement between the two is evidence rather than
 * a tautology.
 */
